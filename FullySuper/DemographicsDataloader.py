...
from dataset.utils_celebA import download, download_and_merge

# Constants
UCI_ADULT_PATH = "../datasets/adult/"
COMPAS_PATH = "../datasets/compas/"
LAW_SCHOOL_PATH = "../datasets/law_school/"
